"""
Django settings for product_APIs project.
...
ROOT_URLCONF = 'product_APIs.urls'
...
WSGI_APPLICATION = 'product_APIs.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    # throttle the api requests for users to prevent DDos (prepping for deployment)
